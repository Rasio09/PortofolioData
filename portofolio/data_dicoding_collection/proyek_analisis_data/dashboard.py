...
# menyiapkan tampilan daily_orders_df
...
# mengurutkan data berdasrkan order_date
...
# sidebar komponen filter dengan menggunakan date input
...
# menyimpan data yang sudah difilter dengan main_df
main_df = all_df[(all_df["order_date"] >= str(start_date)) & (all_df["order_date"] <= str(end_date))]


# untuk melakukan visualisasi data yang sudah dilakukan filtering
...
# melengkapi data dengan visualisasi data pada tampilan dashboard
...
with col2:
    total_revenue = format_currency(daily_orders_df.revenue.sum(), "RP", locale='es_CO') 
...
# tampilan performa penjualan setiap produk menampilkan 5 produl terlaris
...
# tampilan informasi terkait RFM
